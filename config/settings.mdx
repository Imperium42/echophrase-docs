...
Set the global hotkey for toggling recording. Default: **Ctrl+Shift+Space** on Windows/Linux, or the **Dictation key** (mic icon, shown as F5) on macOS. Click the binding to enter capture mode, then press your desired key combination. ESC cancels.
