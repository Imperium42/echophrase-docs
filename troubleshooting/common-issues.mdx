...
<AccordionGroup>
  ...
  <Accordion title="Transcription is slow">
    ...
    2. Confirm GPU acceleration is active in Settings → GPU Acceleration
       (DirectML on Windows, Metal on Apple Silicon)
...
<AccordionGroup>
  <Accordion title="Echophrase won't start">
    ...
    3. Collect `Echophrase.log` from the app's data directory and share it on [Discord](https://discord.com/invite/Er6NUcx)
  </Accordion>
